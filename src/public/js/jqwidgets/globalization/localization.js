            ...
            localization =
                {
                    ...
                    groupsheaderstring: "Arrastre una columna y colóquela aquí para agruparla en esa columna",
                    sortascendingstring: "Ordenamiento ascedente",
                    sortdescendingstring: "Ordenamiento descendente",
                    sortremovestring: "Eliminar odernamiento",
                    groupbystring: "Agrupado por esta columna",
                    groupremovestring: "Eliminar de agrupamiento",
                    ...
                    filterstringcomparisonoperators: ['vacío', 'no vacío', 'contener', 'contener(que coincidan)',
                        'que no contenga', 'que no contenga(que coincidan)', 'comenzar con', 'comenzar con(que coincidan)',
                        'que termine en', 'que termine en(que coincidan)', 'igual', 'Igual(que coincidan)', 'nulo', 'no nulo'],
                    filternumericcomparisonoperators: ['igual', 'no igual', 'menor que', 'menor que o igual', 'mayor que', 'mayor que o igual', 'nulo', 'no nulo'],
                    filterdatecomparisonoperators: ['igual', 'no igual', 'menor que', 'menor o igual que', 'mayor que', 'mayor que o igual', 'nulo', 'no nulo'],
