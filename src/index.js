...
var source = {
    columns: [
        ...
        { key:'Glosa', position:4, start:false, header:{ visible:true, label:'Glosa', class:null, width:15 }, row:{ class:'normal', align:'left', width:15, type:'String' } },
        { key:'CentroCostos', position:5, start:false, header:{ visible:true, label:'Centro de Costos', class:null, width:20 }, row:{ class:'normal', align:'left', width:20, type:'String' } },
        { key:'Sucursal', position:6, start:false, header:{ visible:true, label:'Sucursal', class:null, width:10 }, row:{ class:'normal', align:'left', width:10, type:'String' } },
