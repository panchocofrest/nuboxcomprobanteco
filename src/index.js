...
var source = {
    columns: [
        ...
        { key: 'CentroCostos', tipoControl: 'Dropdown', position: 5, start: false, header: { visible: true, label: 'Centro de Costos', class: null, width: 20 }, row: { class: 'normal', align: 'left', width: 20, type: 'String' } },
        { key: 'Sucursal', tipoControl: 'Dropdown', position: 6, start: false, header: { visible: true, label: 'Sucursal', class: null, width: 10 }, row: { class: 'normal', align: 'left', width: 10, type: 'String' } },
    ...
    movimientos: {
        aux: {
            columns: [
                ...
                { key: 'Documento', tipoControl: 'Dropdown', position: 2, start: false, row: { class: 'normal', align: 'left', width: 10, type: null } },
        ...
        ban: {
            columns: [
                { key: 'Remove', position: 0, start: false, row: { class: 'borrar', align: null, width: null, type: null } },
                { key: 'Cliente', tipoControl: 'Autocomplete', position: 1, start: true, row: { class: 'num-del normal', align: 'left', width: 100, type: null } },
                { key: 'Documento', tipoControl: 'Dropdown', position: 2, start: false, row: { class: 'normal', align: 'left', width: 20, type: null } },
                { key: 'Numero', position: 3, start: false, row: { class: 'normal', align: 'left', width: 5, type: null } },
                { key: 'Fecha', tipoControl: 'DateTimeInput', position: 4, start: false, row: { class: 'normal', align: 'center', width: 15, type: null } },
